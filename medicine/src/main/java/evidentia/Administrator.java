...
public class Administrator implements User{
	...
	public void enroll() throws Exception {
        ...
        Enrollment enrollment = caClient.enroll(this.adminName, this.adminPassword, enrollmentRequestTLS);
	...
	public static void main(String[] args) {
		try (InputStream input = new FileInputStream("src/main/resources/networkConfig.properties")) {
			...
			Administrator admin = new Administrator("admin_" + entityName, "adminpw", pemFilename, caClientUrl, mspName, "org2.department1");
			admin.enroll();
