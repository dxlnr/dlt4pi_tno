/*
 an auto-generated ETB wrapper template for the service 'intra_corporate_transfer'
*/
...
public abstract class intra_corporate_transferETBWRP extends genericWRP {
	...
	public void initialise(){
		serviceName = "intra_corporate_transfer";
		signatureStr = "21";
		modesStr = "+-";
		evidence = "ev(intra_corporate_transfer)";
