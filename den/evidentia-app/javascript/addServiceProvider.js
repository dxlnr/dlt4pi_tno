...
const ccpPath = path.resolve(__dirname, '..', '..', 'evidentia-network', 'connection-coord.json');
...
async function main() {
    ...
    try {
        ...
        await contract.submitTransaction('addServiceProvider', 'sa', '192.168.2.2', '5002', 'infer', 'Static Analysis service');
        console.log('Transaction has been submitted');
        await contract.submitTransaction('addServiceProvider', 'mc', '192.168.2.1', '5001', 'cbmc', 'Model Checking service');
        console.log('Transaction has been submitted');
