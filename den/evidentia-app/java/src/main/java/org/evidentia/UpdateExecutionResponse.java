...
public class UpdateExecutionResponse {
	...
	public static void main(String[] args) throws Exception {
		...
		try (Gateway gateway = builder.connect()) {
			...
			contract.submitTransaction("updateServiceExecutionResponse", "getVisa", "(Form, Passport, Photo, HealthBank, Ticket, Accomodation, SufficientMeans, Time)", "EVIDENCE", "RESPONSE");
