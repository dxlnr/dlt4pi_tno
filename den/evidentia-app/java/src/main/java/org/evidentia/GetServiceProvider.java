...
public class GetServiceProvider {
	...
	public static void main(String[] args) throws Exception {
		...
		try (Gateway gateway = builder.connect()) {
			...
			result =  contract.submitTransaction("requestServiceProvider", "getVisa", "(Form, Passport, Photo, HealthBank, Ticket, Accomodation, SufficientMeans, Time)");

			System.out.println("Transaction has been evaluated, result is: " + new String(result));
			
//			result =  contract.submitTransaction("requestServiceProvider", "infer", "[a,b,c]");
//
//			System.out.println("Transaction has been evaluated, result is: " + new String(result));
		}
	}
