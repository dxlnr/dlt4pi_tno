/*
 an auto-generated ETB wrapper template for the service 'N_alien_has_pronouncement_of_undesirability'
*/
...
public abstract class N_alien_has_pronouncement_of_undesirabilityETBWRP extends genericWRP {
	...
	public void initialise(){
		serviceName = "N_alien_has_pronouncement_of_undesirability";
		signatureStr = "21";
		modesStr = "+-";
		evidence = "ev(N_alien_has_pronouncement_of_undesirability)";
